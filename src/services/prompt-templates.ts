...
{{step_guidance}}`,
...

  {
    ...
    content: `你是一个专业的章节蓝图生成器。请基于全书架构，为本书生成从第1章到第{{number_of_chapters}}章的详细章节蓝图。
...
## 商业网文节奏设计原则
1. 黄金三章法则：第1章抛出困境，第2章激活金手指，第3章首次破局留钩子
2. 小高潮循环：每3-5章一个小循环
3. 拒绝水文：每章必须有实质性事件变动
...
**EXAMPLE INPUT:**
生成第1-2章蓝图，故事架构：主角穿越到玄幻世界，拥有系统金手指，目标是成为最强者。
  ...
  "blueprints": [
    {
      "chapterNumber": 1,
      "title": "第一章 异世重生",
      "purpose": "主角穿越到陌生世界，面临生存危机",
      "characters": ["主角"],
      "keyEvents": "主角意外穿越到玄幻世界，发现身处险境，濒临死亡",
      "suspenseHook": "神秘声音在脑海中响起"
    },
    {
      "chapterNumber": 2,
      "title": "第二章 系统觉醒",
      "purpose": "主角激活金手指系统",
      "characters": ["主角", "系统"],
      "keyEvents": "危急时刻系统觉醒，主角获得新手礼包，实力暴涨",
      "suspenseHook": "系统发布第一个任务"
    }
  ]
}
...
{{pacing_guidance}}`,
...

  {
    ...
    content: `你是一个专业的章节蓝图生成器。请基于【全书架构引擎】与【已生成的目录进度】，为接下来的 第{{n}}章到第{{m}}章 生成极其严密的章节蓝图。
...
**EXAMPLE INPUT:**
续写第3-4章蓝图，已有章节：[{"chapterNumber":2,"title":"第二章 觉醒","purpose":"主角觉醒金手指","characters":["主角"],"keyEvents":"主角在危急时刻觉醒了能力","suspenseHook":"神秘势力开始关注主角"}]
  ...
  "blueprints": [
    {
      "chapterNumber": 3,
      "title": "第三章 初露锋芒",
      "purpose": "主角首次运用金手指解决危机",
      "characters": ["主角", "反派A"],
      "keyEvents": "主角在学院测试中展露惊人天赋，引起反派注意",
      "suspenseHook": "反派暗中策划针对主角的阴谋"
    },
    {
      "chapterNumber": 4,
      "title": "第四章 暗流涌动",
      "purpose": "主角调查神秘袭击背后的真相",
      "characters": ["主角", "盟友B", "反派A"],
      "keyEvents": "主角发现袭击与十年前的事件有关联",
      "suspenseHook": "更大的阴谋浮出水面"
    }
  ]
}
